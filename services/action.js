 ...
 */
async function getPartantForToday(){
    ...
    try {
        ...
        console.log('Get partant for today: finished !!!');
 ...
 */
async function getPartantRPForToday(){
    const dateOrSlug = 'aujourd-hui';
    const date = resolveDate(dateOrSlug);
    ...
    try {
        ...
        console.log('Get partantRP for today: finished !!!');
